...
public class McpConfig {
     ...
     */
    @Bean
    public ToolCallbackProvider irisToolProvider(
            ...
            org.iris.ml.ChurnMcpToolService churnTool
    ) {
