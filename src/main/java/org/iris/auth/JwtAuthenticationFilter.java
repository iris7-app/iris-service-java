...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
     ...
     *       claim {@code https://iris-api/roles} (populated by an Auth0 Action /
    ...
    private void authenticateExternalJwt(String token) {
        ...
        try {
            ...
            // Strategy 2: Auth0 — roles in custom namespace claim https://iris-api/roles.
            ...
            if (authorities.isEmpty()) {
                List<?> auth0Roles = jwt.getClaimAsStringList("https://iris-api/roles");
                if (auth0Roles != null) {
                    auth0Roles.stream()
                            .filter(String.class::isInstance)
                            .map(String.class::cast)
