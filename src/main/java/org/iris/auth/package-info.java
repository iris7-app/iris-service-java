 ...
 *       {@link org.iris.auth.KeycloakConfig}.</li>
 *
 ...
 * <ul>
 *   <li>{@code SecurityConfig} (loaded from {@code org.iris.auth.SecurityConfig}) — wires the filter chain and CORS.</li>
 *   <li>{@link org.iris.observability.AuditService} — records login attempts, token refreshes, and admin actions.</li>
 *   <li>{@link org.iris.resilience.RateLimitingFilter} — runs before authentication so the token bucket drains on anonymous traffic too.</li>
 * </ul>
 */
