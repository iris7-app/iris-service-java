...
public class ChaosService {
    ...
    /** Namespace holding the iris backend pods — experiments target these. */
    ...
    public String trigger(ChaosExperiment experiment) {
        ...
        String name = "iris-" + experiment.slug() + "-" + Instant.now().toEpochMilli();
        ...
        GenericKubernetesResource cr = new GenericKubernetesResourceBuilder()
                ...
                .withNewMetadata()
                    ...
                    .withLabels(Map.of(
                            "app.iris.demo/chaos", experiment.slug(),
                            "app.iris.demo/triggered-from", "ui"))
                .endMetadata()
                .build();
    ...
    private Map<String, Object> buildSpec(ChaosExperiment exp) {
        ...
        return switch (exp) {
            ...
            case NETWORK_DELAY -> Map.of(
                    "action", "delay",
                    KEY_MODE, "all",          // all iris pods get the latency
                    KEY_DURATION, exp.duration(),
                    KEY_SELECTOR, backendSelector,
                    "delay", Map.of(
                            "latency", "200ms",
