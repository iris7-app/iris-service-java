 ...
 * {@code org.iris.observability.*}, because the default persistence
 ...
 * documented for {@code org.iris.customer.port} and is enforced at
 * build time by {@code ArchitectureTest}.
 *
 * <h2>Scope (as of 2026-04-22)</h2>
 *
 * <ul>
 *   <li>{@link org.iris.observability.port.AuditEventPort} — write-side
 *       port for security-audit events (LOGIN_*, CUSTOMER_*, TOKEN_*).
 *       Read-side (page/customer-id lookup) remains on
 *       {@link org.iris.observability.AuditService} directly; a
 ...
 * {@code org.iris.customer.port.CustomerEventPort}). Both passed the
 ...
 * into callers.
 */
package org.iris.observability.port;
