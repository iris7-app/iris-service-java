 ...
 * live in adapter packages (e.g. {@code org.iris.messaging.KafkaCustomerEventPublisher}
 * implements {@link org.iris.customer.port.CustomerEventPort} using Apache
 * Kafka).
 *
 ...
 *
 * Per {@link org.iris.customer} (see ADR-0044 superseding ADR-0008),
 ...
 */
package org.iris.customer.port;
