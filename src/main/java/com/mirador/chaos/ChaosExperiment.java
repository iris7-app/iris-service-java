...
public enum ChaosExperiment {
    ...
    /**
     * Kill a random mirador backend pod with SIGKILL. Exposes Spring Boot
     * restart time on the Grafana golden-signals dashboard.
     */
    POD_KILL("pod-kill", "PodChaos", "30s"),

    /**
     * Inject 200 ms latency on all packets from mirador backend pods toward
    ...
    /**
     * Saturate 70 % of one vCPU on a random mirador backend pod for 2
