package com.example.mirador.messaging;
 ...
 * {@link com.example.mirador.messaging.CustomerEnrichReply} messages.
 *
...
public class KafkaConfig {
    ...
    private DefaultKafkaConsumerFactory<String, Object> listenerConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(Map.of(
                ...
                JacksonJsonDeserializer.TRUSTED_PACKAGES, "com.example.mirador.messaging"
        ));
    }
    ...
    private DefaultKafkaConsumerFactory<String, CustomerEnrichReply> replyConsumerFactory() {
        ...
        deser.addTrustedPackages("com.example.mirador.messaging");
        return new DefaultKafkaConsumerFactory<>(Map.of(
                ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers,
