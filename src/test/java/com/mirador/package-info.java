/**
 * Test source root — mirrors the structure of {@code src/main/java/com/mirador}.
 *
 ...
 * ({@code com.mirador.customer} tests → {@code src/test/java/com/mirador/customer}).
 ...
 * <ul>
 *   <li>{@code MiradorTestBase} — base class for integration tests, starts
 *       the shared Testcontainers network once per test JVM via {@code @TestInstance(PER_CLASS)}.</li>
 *   <li>{@link com.mirador.config} — Spring test configuration overrides
