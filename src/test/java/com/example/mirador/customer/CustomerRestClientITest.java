...
import com.example.mirador.AbstractIntegrationTest;
 ...
 * {@link com.example.mirador.auth.JwtAuthenticationFilter}. A JWT token is obtained
...
class CustomerRestClientITest extends AbstractIntegrationTest {
     ...
     * {@link com.example.mirador.observability.RequestIdFilter},
     * {@link com.example.mirador.resilience.RateLimitingFilter}, etc.) and Spring
