package com.example.mirador;

import com.example.mirador.config.TestAiConfig;
 ...
 * {@link com.example.mirador.integration.BioService} with a Mockito stub (no Ollama needed).
 */
@SpringBootTest
