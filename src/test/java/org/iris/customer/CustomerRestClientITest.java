 ...
 * {@link org.iris.auth.JwtAuthenticationFilter}. A JWT token is obtained
...
class CustomerRestClientITest extends AbstractIntegrationTest {
     ...
     * {@link org.iris.observability.RequestIdFilter},
     * {@link org.iris.resilience.RateLimitingFilter}, etc.) and Spring
