...
// SB3 test overlay — mirrors src/main/java-overlays/sb3/org/iris/messaging/KafkaConfig.java :
...
// Main test at src/test/java/org/iris/messaging/KafkaConfigTest.java is
...
class KafkaConfigTest {
    ...
    void listenerConsumerFactory_usesEarliestOffsetResetAndTrustedPackages() {
        ...
        assertThat(configs).containsEntry(JsonDeserializer.TRUSTED_PACKAGES, "org.iris.messaging");
    }
