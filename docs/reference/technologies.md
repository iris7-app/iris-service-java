...
### Spring Bean Validation (Jakarta Validation)
...
### `spring-boot-webmvc-test` + RestTestClient
...
### GitLab Secret Detection (gitleaks)
...
### Maven `analyze` / `tree` / `license` reporting bundle
