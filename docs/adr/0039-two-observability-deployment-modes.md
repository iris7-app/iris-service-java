# ADR-0039 — moved to `iris-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`iris-service-shared/docs/adr/0039-two-observability-deployment-modes.md`](https://gitlab.com/iris-7/iris-service-shared/-/blob/main/docs/adr/0039-two-observability-deployment-modes.md)
...
iris-service-java/docs/adr/ and iris-service-shared/docs/adr/
