# ADR-0010 — moved to `iris-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`iris-service-shared/docs/adr/0010-otlp-push-to-collector.md`](https://gitlab.com/iris-7/iris-service-shared/-/blob/main/docs/adr/0010-otlp-push-to-collector.md)
