# ADR-0055 — moved to `iris-common`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`iris-common/docs/adr/0055-shell-based-release-automation.md`](https://gitlab.com/iris-7/iris-common/-/blob/main/docs/adr/0055-shell-based-release-automation.md)
