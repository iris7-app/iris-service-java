# ADR-0036 — moved to `iris-service-shared`

**Status** : Moved

This ADR's canonical version lives in the upstream submodule :

- **Canonical path** : [`iris-service-shared/docs/adr/0036-multi-cloud-terraform-posture.md`](https://gitlab.com/iris-7/iris-service-shared/-/blob/main/docs/adr/0036-multi-cloud-terraform-posture.md)
